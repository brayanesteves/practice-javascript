...
function getPosts() {
    ...
    fetch(`${POSTS_EMBED}&page=${pages}&per_page=${perPages}`).then((res) => res.ok ? res.json() : Promise.reject(res)).then((json) => {
...
w.addEventListener("scroll", (e) => {
    ...
    // console.log(d.documentElement); // Output: <html lang="es"><head>...</head><body>...</body></html>
    // console.log(scrollTop, clientHeight, scrollHeight); // For Example. Output: 1 617 11033
